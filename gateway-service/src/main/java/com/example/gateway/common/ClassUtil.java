...
public class ClassUtil extends ClassUtils {
    ...
    public static final <T> Constructor<T> getConstructor(Class<T> clazz, Class<?>... parameterTypes) throws NoSuchMethodException {
        Assert.notNull(clazz, "Class required");
        return clazz.getConstructor(parameterTypes);
    }

    @SuppressWarnings("unchecked")
    public static final <T> T newInstance(Class<?> clazz, Class<?>[] parameterTypes, Object... initargs) {
        try {
